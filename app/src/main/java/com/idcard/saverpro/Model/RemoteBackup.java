...
import static com.idcard.saverpro.Activity.SettingActivity.REQUEST_CODE_CREATION;
import static com.idcard.saverpro.Activity.SettingActivity.REQUEST_CODE_OPENING;
import static com.idcard.saverpro.Activity.SettingActivity.REQUEST_CODE_SIGN_IN;
...
public class RemoteBackup {
    ...
    public RemoteBackup(SettingActivity activity) {
    ...
    private Task<Void> createFileIntentSender(DriveContents driveContents) {
        ...
        final String inFileName = activity.getDatabasePath("db_cardwallet").toString();
